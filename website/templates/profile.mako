...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        % if user['is_profile']:
    		...
    		<tr>
    		    <td>&nbsp;</td>
    			<td><a href="${cas_server_url}/Shibboleth.sso/MFA?service=${osf_service_url}/profile/" class="btn btn-info">${_("Configure multi-factor authentication (MFA)")}</a></td><!--@R2022-48-->
    		</tr>		
    		% endif
        % endif
        </table>
